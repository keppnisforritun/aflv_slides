...
\node[circle, draw, very thick, ->] (0) at (0,0) {0};
\node[circle, draw, very thick, ->] (1) at (0,1) {1};
\node[circle, draw, very thick, ->] (2) at (1,0) {2};
\node[circle, draw, very thick, ->] (3) at (2,0) {3};
\node[circle, draw, very thick, ->] (4) at (1,1) {4};
\node[circle, draw, very thick, ->] (5) at (1,2) {5};

\draw[very thick, ->]  (0) -- (1) node[midway,left,gray!60!black] () {$\substack{\uparrow\\1}$}  node[midway,right,gray!60!black] () {$\substack{\downarrow\\7}$};
\draw[very thick, red!80!black, ->]  (1) -- (5) node[pos=.25,above left,gray!60!black] () {$\substack{\times\\6}$};
\draw[very thick, ->]  (0) -- (2) node[midway,above,gray!60!black] () {$\substack{\rightarrow\\8}$} node[midway,below,gray!60!black] () {$\substack{\leftarrow\\13}$};
\draw[very thick, ->]  (2) -- (3) node[midway,above,gray!60!black] () {$\substack{\rightarrow\\9}$} node[midway,below,gray!60!black] () {$\substack{\leftarrow\\12}$} ;
\draw[very thick, ->]  (1) -- (4) node[midway,above,gray!60!black] () {$\substack{\rightarrow\\2}$} node[midway,below,gray!60!black] () {$\substack{\leftarrow\\5}$};
\draw[very thick, green!80!black, ->]  (3) -- (4) node[pos=.25,above right,gray!60!black] () {$\substack{\times\\11}$};
\draw[very thick, ->]  (4) -- (5) node[midway,left,gray!60!black] () {$\substack{\uparrow\\3}$} node[midway,right,gray!60!black] () {$\substack{\downarrow\\4}$};
\draw[very thick, blue!80!black, ->] (3) edge[bend right, above, pos=0.25] node[gray!60!black]{$\substack{\times\\10}$} (0) ;

\begin{scope}[xshift=2cm,yshift=1cm]

\draw[very thick, ->] (1,0.75) -- ++(0.5,0)node[right, black]{Tree edges};
\draw[very thick, red!80!black, ->] (1,0.25) -- ++(0.5,0)node[right, black]{Forward edge};
\draw[very thick, green!80!black, ->] (1,-0.25) -- ++(0.5,0)node[right, black]{Cross edge};
\draw[very thick, blue!80!black, ->] (1,-0.75) -- ++(0.5,0)node[right, black]{Back edge};
...
% \begin{frame}[plain]{Example problem: Come and Go}
%     \begin{itemize}
...
\begin{frame}[plain,fragile]{Kahn}
